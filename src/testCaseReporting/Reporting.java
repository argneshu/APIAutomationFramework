...
//		//augdDriver = new Augmenter().augment(DriverSession.getLastExecutionDriver());
//		File newImageFile = null;
//		try {
//		File scrFile = ((TakesScreenshot) DriverSession.getLastExecutionDriver()).getScreenshotAs(OutputType.FILE);
//		
//		   newImageFile = new File(SuiteReporting.pathToSuiteFolder+ "/screenShot");
//		
