...
public class SuiteReporting extends Reporting {
	...
	public void createConsolidateHeader() {
		try {
			...
			consolidatePrintHtml.println("<h2 align='center'>" + "API Execution Report" + "</h2>");
	...
	public void checkTestCaseStatus(File testCaseFile) {// change argument file
														// to string
		String Status = "PASS";
		String[] line3;
		String sPercent = "";
		...
		try {
			String resultLink = "<a href=\"" + testCaseFile + "\">TestCaseResultFile</a>";
	...
	public File createTempDir() throws IOException {
		...
		do {
			...
			String dirName = "Zopper_Results_" + getTime();
