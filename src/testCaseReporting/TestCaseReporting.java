...
public class TestCaseReporting extends Reporting {
	...
	public void Openfile(String TestCase) {
		try {

			// htmlfile = new FileOutputStream(SuiteReporting.pathToSuiteFolder+
			// "/TestCase/" + testCaseName+"
			// ("+GlobalVar.CURRENT_EXECUTION_MODE+")"+".html", true);
			// System.out.println(SuiteReporting.pathToSuiteFolder+ "/TestCase/"
			// + testCaseName+"
			// ("+GlobalVar.CURRENT_EXECUTION_MODE+")"+".html");

			htmlfile = new FileOutputStream(SuiteReporting.pathToSuiteFolder + "/TestCase/" + TestCase + ".html", true);
	...
	public void openReport() {
		try {
			File htmlFile = new File(SuiteReporting.pathToSuiteFolder + "/suite.html");
	...
	public void teststepreporting(String strActualResult, String strPassFail, String sExpectedMessage, String time) {
		try {
...
//			 Openfile();
			...
			printhtml
					.append("<td width='13%' bgcolor='#FFFFDC' valign='middle' align='center' ><font color='#000000' face='Tahoma' size='2'>"
							+ RestClient.getResponseCode() + "</font></td>");
			printhtml
	...
	public void header(String TestCase) {
		try {
			startTime = getTime();
			Openfile(TestCase);
			...
			printhtml.println("<h2 align='center'>" + TestCase + " API Execution Report</h2>");
			...
			printhtml.println(
					"<td width='2%' bgcolor='#CCCCFF' align='center'><b><font color='#000000' face='Tahoma' size='2'>Response Code</font></b></td>");
			printhtml.println(
			...
			printhtml.println(
					"<td width='28%' bgcolor='#CCCCFF' align='center'><b><font color='#000000' face='Tahoma' size='2'>Execution Time(SS:mmm)</font></b></td>");
	...
	public void footer() {
		try {
			...
			printhtml.println(
					"<tr><td width='45%' bgcolor='#FFFFDC'><b><font face='Tahoma' size='2'>Execution Time (MM:SS.mmm)</font></b></td><td width='55%' bgcolor= '#FFFFDC'><font face='Tahoma' size='2'>"
